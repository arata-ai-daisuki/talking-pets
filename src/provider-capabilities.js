...
const PROVIDER_CAPABILITIES = Object.freeze({
  ...
  "openai-compatible-local": Object.freeze({
    ...
    status: "optional-local-manual",
    local: true,
    defaultRouteEligible: false,
    needsExternalRuntime: true,
    needsModelDownload: false,
    needsApiKey: false,
    publicClaimLevel: "opt-in-local-endpoint",
    languages: Object.freeze({
      ja: unknownSupport("Local OpenAI-compatible speech endpoints are manually selectable; language support depends on the local endpoint, model, and voice."),
      en: unknownSupport("Local OpenAI-compatible speech endpoints are manually selectable; language support depends on the local endpoint, model, and voice."),
      ko: unknownSupport("Local OpenAI-compatible speech endpoints are manually selectable; language support depends on the local endpoint, model, and voice."),
      zh: unknownSupport("Local OpenAI-compatible speech endpoints are manually selectable; language support depends on the local endpoint, model, and voice."),
      other: unknownSupport("Local OpenAI-compatible speech endpoints are manually selectable; language support depends on the local endpoint, model, and voice."),
    }),
  }),
  "openai-tts-api": Object.freeze({
    id: "openai-tts-api",
    label: "OpenAI Audio speech API",
    status: "optional-remote-manual",
    local: false,
    defaultRouteEligible: false,
    needsExternalRuntime: false,
    needsModelDownload: false,
    needsApiKey: true,
    publicClaimLevel: "opt-in-remote-endpoint",
    languages: Object.freeze({
      ja: unknownSupport("OpenAI TTS is manually selectable only with explicit remote API opt-in, API credentials, billing acknowledgement, and provider-specific evidence."),
      en: unknownSupport("OpenAI TTS is manually selectable only with explicit remote API opt-in, API credentials, billing acknowledgement, and provider-specific evidence."),
      ko: unknownSupport("OpenAI TTS is manually selectable only with explicit remote API opt-in, API credentials, billing acknowledgement, and provider-specific evidence."),
      zh: unknownSupport("OpenAI TTS is manually selectable only with explicit remote API opt-in, API credentials, billing acknowledgement, and provider-specific evidence."),
      other: unknownSupport("OpenAI TTS is manually selectable only with explicit remote API opt-in, API credentials, billing acknowledgement, and provider-specific evidence."),
    }),
  }),
