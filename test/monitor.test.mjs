...
test("detects npm pack scope drift", () => {
  ...
  const completePackIssues = packIssues({
    ...
    files: [
      ...
      { path: "docs/contributor-entrypoints.md", mode: 0o644 },
      ...
      { path: "docs/install-update-uninstall.md", mode: 0o644 },
      { path: "docs/pr-preflight-kit.md", mode: 0o644 },
      { path: "docs/public-repo-review-checklist.md", mode: 0o644 },
      { path: "docs/real-device-verification.md", mode: 0o644 },
      { path: "docs/release-doc-sync-matrix.md", mode: 0o644 },
      { path: "docs/release-notes-template.md", mode: 0o644 },
      { path: "docs/verification-matrix.md", mode: 0o644 },
