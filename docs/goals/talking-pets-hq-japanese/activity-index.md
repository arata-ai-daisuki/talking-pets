...
- Current active task: `T207`
- Current focus: public proof導線をsupport claimなしで磨く。

## Kanban Snapshot

| Column | Count | Meaning |
| --- | ---: | --- |
| Done | 207 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| --- | --- | ---: | ---: | --- |
| 相庭 愛 | HQ Producer | 62 | 0 | 判断カード、全体整理、Master確認。 |
| 星宮 未来 | Outreach Lead | 38 | 0 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
| 白瀬 怜奈 | Risk / Review Lead | 22 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
...
| 文月 栞里 | Docs / Operations Lead | 16 | 1 | docs整備、hygiene、activity index、運用導線。 |
...
| `T207` | 文月 栞里 / 白瀬 怜奈 | active | public proof導線をsupport claimなしで磨く準備中。 |
