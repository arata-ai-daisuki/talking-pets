...
| --- | ---: | --- |
| Done | 240 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 53 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 42 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 30 | 0 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T240` | 歌澄 音羽 / 白瀬 怜奈 | active | local TTS設計の境界をinstall/model/APIなしで再確認中。 |
