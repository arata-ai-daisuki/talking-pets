...
| --- | ---: | --- |
| Done | 220 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 34 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 36 | 0 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 23 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T220` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証の受け口をclaim変更なしで再確認中。 |
