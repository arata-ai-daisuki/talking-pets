...
| --- | ---: | --- |
| Done | 262 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 星宮 未来 | Outreach Lead | 56 | 0 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
...
| 言守 詞葉 | Multilingual Lead | 37 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T262` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証の境界をdedicated-provider claimなしで再確認中。 |
