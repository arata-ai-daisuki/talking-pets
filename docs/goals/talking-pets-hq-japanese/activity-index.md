...
| --- | ---: | --- |
| Done | 229 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 43 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 39 | 0 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 26 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T229` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証の境界をsupport claim変更なしで再確認中。 |
