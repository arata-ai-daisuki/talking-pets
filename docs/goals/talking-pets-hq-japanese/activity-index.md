...
| --- | ---: | --- |
| Done | 267 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 78 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 51 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
...
| `T267` | 歌澄 音羽 / 白瀬 怜奈 | active | local TTS境界をinstall / model download / API callなしで再確認中。 |
