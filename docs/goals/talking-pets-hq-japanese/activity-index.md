...
| --- | ---: | --- |
| Done | 261 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 歌澄 音羽 | Voice Provider Lead | 49 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
...
| `T261` | 歌澄 音羽 / 白瀬 怜奈 | active | local TTS境界をinstall / model download / API callなしで再確認中。 |
