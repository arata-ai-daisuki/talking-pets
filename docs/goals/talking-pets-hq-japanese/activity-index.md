...
- Current active task: `T193`
- Current focus: Local TTS実験へ進む場合のMaster承認範囲を確認する。

## Kanban Snapshot

| Column | Count | Meaning |
| --- | ---: | --- |
| Done | 193 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 歌澄 音羽 | Voice Provider Lead | 29 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
...
| `T193` | 歌澄 音羽 / 白瀬 怜奈 | active | Local TTS approval checkを準備中。 |
