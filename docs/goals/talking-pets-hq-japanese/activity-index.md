...
| --- | ---: | --- |
| Done | 217 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 31 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 35 | 0 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 22 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T217` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証の受け口を再確認中。 |
