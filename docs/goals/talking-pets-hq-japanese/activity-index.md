...
| --- | ---: | --- |
| Done | 252 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 白瀬 怜奈 | Risk / Review Lead | 65 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 46 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 34 | 0 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T252` | 歌澄 音羽 / 白瀬 怜奈 | active | local TTS境界をinstall / dependency / model download / API callなしで再確認中。 |
