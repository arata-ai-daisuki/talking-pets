...
| --- | ---: | --- |
| Done | 244 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 星宮 未来 | Outreach Lead | 50 | 0 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
| 白瀬 怜奈 | Risk / Review Lead | 57 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 44 | 0 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 31 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T244` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証の境界をclaim変更なしで再確認中。 |
