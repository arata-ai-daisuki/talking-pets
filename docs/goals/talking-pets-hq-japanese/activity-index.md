...
| --- | ---: | --- |
| Done | 270 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 歌澄 音羽 | Voice Provider Lead | 52 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
...
| `T270` | 歌澄 音羽 / 白瀬 怜奈 | active | local TTS provider設計境界を依存追加なしで再確認中。 |
