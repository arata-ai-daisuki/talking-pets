...
| --- | ---: | --- |
| Done | 271 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 星宮 未来 | Outreach Lead | 59 | 0 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
| 白瀬 怜奈 | Risk / Review Lead | 73 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
| 歌澄 音羽 | Voice Provider Lead | 53 | 0 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
| 言守 詞葉 | Multilingual Lead | 40 | 1 | ko/zh fallback、多言語fixture、dedicated provider evidence境界。 |
...
| `T238` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 3を追加し、fallback-only境界を維持。 |
| `T239` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 3を追加し、再送・催促なしでwaitを維持。 |
| `T240` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 3を追加し、evidence-first / design-only境界を維持。 |
| `T241` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 4を追加し、fallback-only境界を維持。 |
| `T242` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 4を追加し、再送・催促なしでwaitを維持。 |
| `T243` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 4を追加し、evidence-first / design-only境界を維持。 |
| `T244` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 5を追加し、fallback-only境界を維持。 |
| `T245` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 5を追加し、再送・催促なしでwaitを維持。 |
| `T246` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 5を追加し、evidence-first / design-only境界を維持。 |
| `T247` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 6を追加し、fallback-only境界を維持。 |
| `T248` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 6を追加し、再送・催促なしでwaitを維持。 |
| `T249` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 6を追加し、evidence-first / design-only境界を維持。 |
| `T250` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 7を追加し、fallback-only境界を維持。 |
| `T251` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 7を追加し、再送・催促なしでwaitを維持。 |
| `T252` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 7を追加し、evidence-first / design-only境界を維持。 |
| `T253` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 8を追加し、fallback-only境界を維持。 |
| `T254` | 星宮 未来 / 白瀬 怜奈 | done | Outreach waiting lane boundary watch 8を追加し、再送・催促なしでwaitを維持。 |
| `T255` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 8を追加し、evidence-first / design-only境界を維持。 |
| `T256` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 9を追加し、fallback-only境界を維持。 |
| `T257` | 星宮 未来 / 白瀬 怜奈 | done | Boundary watch 9を追加し、再送・催促なしでwaitを維持。 |
| `T258` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 9を追加し、evidence-first / design-only境界を維持。 |
| `T259` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 10を追加し、fallback-only境界を維持。 |
| `T260` | 星宮 未来 / 白瀬 怜奈 | done | Boundary watch 10を追加し、再送・催促なしでwaitを維持。 |
| `T261` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 10を追加し、evidence-first / design-only境界を維持。 |
| `T262` | 言守 詞葉 / 白瀬 怜奈 | done | Multilingual Verification Boundary Watch Result 11を追加し、fallback-only境界を維持。 |
| `T263` | 星宮 未来 / 白瀬 怜奈 | done | Boundary watch 11を追加し、再送・催促なしでwaitを維持。 |
| `T264` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 11を追加し、evidence-first / design-only境界を維持。 |
...
| `T269` | 星宮 未来 / 白瀬 怜奈 | done | Boundary watch 13を追加し、再送・催促なしでwaitを維持。 |
| `T270` | 歌澄 音羽 / 白瀬 怜奈 | done | Local TTS Boundary Watch Result 13を追加し、evidence-first / design-only境界を維持。 |
| `T271` | 言守 詞葉 / 白瀬 怜奈 | active | 多言語検証境界をsupport wording変更なしで再確認中。 |
