...
- Current active task: `T188`
- Current focus: Outreach send queueを現行リンクと現在のaskに合わせて再点検する。

## Kanban Snapshot

| Column | Count | Meaning |
| --- | ---: | --- |
| Done | 188 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 星宮 未来 | Outreach Lead | 33 | 1 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
...
| `T188` | 星宮 未来 | active | Outreach send queue refreshを準備中。 |
