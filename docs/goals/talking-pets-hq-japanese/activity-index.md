...
- Current active task: `T203`
- Current focus: local TTSのA/B/C承認判断カードを準備する。

## Kanban Snapshot

| Column | Count | Meaning |
| --- | ---: | --- |
| Done | 203 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 歌澄 音羽 | Voice Provider Lead | 31 | 1 | TTS provider、VOICEVOX/Irodori/sherpa/Melo/API設計。 |
...
| `T203` | 歌澄 音羽 / 白瀬 怜奈 | active | Local TTS approval decisionを準備中。 |
