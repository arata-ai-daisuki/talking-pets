...
- Current active task: `T206`
- Current focus: 次のpublic proof向け小PR候補を選ぶ。

## Kanban Snapshot

| Column | Count | Meaning |
| --- | ---: | --- |
| Done | 206 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| --- | --- | ---: | ---: | --- |
| 相庭 愛 | HQ Producer | 61 | 1 | 判断カード、全体整理、Master確認。 |
...
| 文月 栞里 | Docs / Operations Lead | 15 | 1 | docs整備、hygiene、activity index、運用導線。 |
...
| `T206` | 相庭 愛 / 文月 栞里 | active | 次のpublic proof向け小PR候補を整理中。 |
