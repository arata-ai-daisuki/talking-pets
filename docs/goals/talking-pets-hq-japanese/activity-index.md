...
| --- | ---: | --- |
| Done | 236 | 完了済みの小PR、調査、判断カード、検証receipt。 |
...
| 星宮 未来 | Outreach Lead | 47 | 1 | SNS/outreach、候補表、返信ドラフト、送信後記録。 |
| 白瀬 怜奈 | Risk / Review Lead | 50 | 1 | claim境界、license/privacy/API、セルフレビュー。 |
...
| `T236` | 星宮 未来 / 白瀬 怜奈 | active | outreach waiting laneを再送・催促なしで再確認中。 |
