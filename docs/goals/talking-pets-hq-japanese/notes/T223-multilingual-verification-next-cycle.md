# T223 Multilingual Verification Next Cycle

## Objective

T222のlocal TTS approval next cycle後に、多言語検証の受け口へ戻る。

## Scope

- Multilingual Verification Follow-Up Watchを確認する。
...
- decision: `multilingual_verification_next_cycle`
- owner: `言守 詞葉 / 白瀬 怜奈`
- status: active
