...
- model download / API call / dependency追加なしで、次候補を比較する。
- MeloTTS、sherpa、Piper、API TTSの現在地をProvider comparisonとdesign notesに照らして整理する。
- 次に進める場合の小PR候補と、Master承認が必要な停止線を分ける。
...
- owner: `歌澄 音羽 / 白瀬 怜奈`
- status: active
- next: compare local TTS candidates and recommend the next safe small PR.
