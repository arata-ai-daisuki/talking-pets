# T240 Local TTS Boundary Watch

## Objective

T239のoutreach waiting lane boundary watch後に、local TTS設計の境界へ戻る。
...
- owner: `歌澄 音羽 / 白瀬 怜奈`
- status: done
- result: Local TTS Boundary Watch Result 3を追加し、VOICEVOX / Irodoriはevidence-first、Kokoroはmodel-download approval-gated、sherpa / MeloTTS / APIはdesign-onlyまたはopt-inの境界を維持した。
