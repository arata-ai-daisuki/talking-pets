...
| --- | --- | --- | --- |
| Local TTS approval check | 歌澄 音羽 / 白瀬 怜奈 | Active | scorecard gapはdesign-note質問へ落ちたので、実験へ進む場合はMaster承認範囲を確認する。 |
...
| Verification issue watch | 文月 栞里 / 白瀬 怜奈 | 多言語intakeの振り分けが整ったので、Issue #23-#26の受け入れ状態を必要に応じて見る。 | 返信やclaim変更なしで、次に必要なdocs作業だけを切れる。 |
