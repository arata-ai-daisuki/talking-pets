...
| --- | --- | --- | --- |
| Release proof package refresh | 文月 栞里 / 白瀬 怜奈 | Active | README claimを変えずに公開証跡リンクを確認する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Outreach cadence later check | 星宮 未来 | OpenClaw/V1GPTの催促禁止日は2026-06-17なので、それまでは返信が来た時だけ記録する。 | 再送せず、必要なら返信intakeだけ更新できる。 |
