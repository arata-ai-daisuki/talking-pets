...
| --- | --- | --- | --- |
| Outreach cadence later check | 星宮 未来 / 白瀬 怜奈 | Active | OpenClaw/V1GPTへ再送せず、返信が来た時だけintakeへ回せる状態を確認する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Local TTS approval follow-up | 歌澄 音羽 / 白瀬 怜奈 | provider候補は整理済みなので、次にMaster承認が必要な境界だけを再確認できる。 | 依存追加やdownloadなしで、次に実験できる候補が明確になる。 |
