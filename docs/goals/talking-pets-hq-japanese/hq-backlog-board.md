...
| --- | --- | --- | --- |
| Outreach送信準備 | 星宮 未来 | Active | 候補、使うテンプレ、送信後記録先を1枚にする。 |
...
| T166-T169 | HQ Activity Index、Minimal Multilingual Report Form、report form follow-up copy、HQ Backlog Board。 | [Activity Index](activity-index.md), [Real-device verification](../../real-device-verification.md#minimal-multilingual-report-form), [HQ Backlog Board](hq-backlog-board.md) |
