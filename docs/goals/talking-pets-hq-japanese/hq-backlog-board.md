...
| --- | --- | --- | --- |
| Backlog refresh | 相庭 愛 / 文月 栞里 | Active | T181-T184で進んだMeloTTS、多言語、SNS導線の波を畳み、次候補を見える化する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Local TTS next choice refresh | 歌澄 音羽 / 白瀬 怜奈 | MeloTTS detect-only、sherpa optional install確認、provider feedback intakeが揃ったので、次に実験するなら何かを再評価する。 | model download/API callなしで、次の小PR候補とMaster承認が必要な境界が明確。 |
...
| T184 | README/SNS route tune-up。 | [T184 receipt](notes/T184-readme-sns-route-tuneup-next.md), [README](../../../README.md), [SNS strategy](../../research/sns-outreach-strategy.md) |
