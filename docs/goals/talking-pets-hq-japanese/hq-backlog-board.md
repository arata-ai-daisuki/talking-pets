...
| --- | --- | --- | --- |
| MeloTTS installer detect-only wording | 白瀬 怜奈 | Active | installer/configに進む場合でも、install/downloadなしの案内だけに限定する範囲を決める。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Provider feedback capture | 星宮 未来 / 歌澄 音羽 | outreach返信や外部知見が来た時にMeloTTS/Piper/sherpa判断へ反映する。 | 返信をSearch Review Logとprovider scorecardへ手動で記録できる。 |
