...
| --- | --- | --- | --- |
| 多言語検証 | 言守 詞葉 | Active | Minimal Multilingual Test Packで、fallback-only/provider-specificの報告を受け取りやすくする。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| README/SNS導線 | 星宮 未来 | 多言語検証パックとReady-To-Send Queueがつながったので、次はREADME/SNSの見え方を整えやすい。 | Star依頼を強くしすぎず、demo/verification/outreach導線が1画面で追える。 |
