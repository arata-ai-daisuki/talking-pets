...
| --- | --- | --- | --- |
| Local TTS evidence request | 歌澄 音羽 | Active | A: VOICEVOX/Irodori外部検証継続のため、短い依頼文を用意する。 |
...
| T166-T171 | HQ Activity Index、Minimal Multilingual Report Form、report form follow-up copy、HQ Backlog Board、Ready-To-Send Queue、Local TTS Master Choice Card。 | [Activity Index](activity-index.md), [Real-device verification](../../real-device-verification.md#minimal-multilingual-report-form), [HQ Backlog Board](hq-backlog-board.md), [Outreach targets](../../research/x-outreach-targets.md#ready-to-send-queue), [Provider comparison](../../research/tts-provider-comparison.md#local-tts-master-choice-card) |
