...
| --- | --- | --- | --- |
| Provider feedback capture | 星宮 未来 | Active | outreach返信や外部知見が来た時にMeloTTS/Piper/sherpa判断へ反映する導線を更新する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Multilingual evidence refresh | 言守 詞葉 / 歌澄 音羽 | provider feedback導線の次に、ko/zh dedicated provider evidenceを最新の小テスト導線へ戻す。 | README claimを増やさず、検証協力者が報告しやすいフォームが最新化される。 |
