...
| --- | --- | --- | --- |
| Multilingual evidence queue check | 言守 詞葉 / 白瀬 怜奈 | Active | README claimを変えず、fallback-only / provider-specificの分類queueを確認する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Backlog wave refresh | 相庭 愛 / 文月 栞里 | T195-T199でproof/outreach/local TTS/multilingualの波が進んだので、次の候補を見直す。 | Active/Next/Backlogが最新の判断順になる。 |
