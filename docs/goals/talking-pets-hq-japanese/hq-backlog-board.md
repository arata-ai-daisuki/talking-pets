...
| --- | --- | --- | --- |
| Backlog wave refresh | 相庭 愛 / 文月 栞里 | Active | T195-T199の完了波を畳み、Active/Next/Backlogを再整理する。 |

## Next

| Card | Owner | Why next | Done when |
| --- | --- | --- | --- |
| Verification issue later watch | 文月 栞里 / 白瀬 怜奈 | Issue #23-#26は返信待ちなので、次の波では再確認だけを小さく切れる。 | 新しいpublic evidenceがあれば記録し、なければclaim変更なしで閉じる。 |
...
| T195 | Verification issue watch。 | [T195 receipt](notes/T195-verification-issue-watch.md), [Issue Watch Snapshot](../../verification-status.md#issue-watch-snapshot) |
| T196 | Release proof package refresh。 | [T196 receipt](notes/T196-release-proof-package-refresh.md), [Release Proof Package Index](../../verification-status.md#release-proof-package-index) |
| T197 | Outreach cadence later check。 | [T197 receipt](notes/T197-outreach-cadence-later-check.md), [Reply Waiting Intake Queue](../../research/x-outreach-targets.md#reply-waiting-intake-queue) |
| T198 | Local TTS approval follow-up。 | [T198 receipt](notes/T198-local-tts-approval-follow-up.md), [Local TTS Approval Follow-Up Snapshot](../../research/tts-provider-comparison.md#local-tts-approval-follow-up-snapshot) |
| T199 | Multilingual evidence queue check。 | [T199 receipt](notes/T199-multilingual-evidence-queue-check.md), [Multilingual Evidence Intake Queue](../../real-device-verification.md#multilingual-evidence-intake-queue) |
