...
| --- | --- | --- | --- |
| Outreach reply intake | 星宮 未来 | Active | OpenClaw/V1GPTはsentなので、返信が来た時だけpublic URLとtechnical summaryを記録する。 |
...
| Release proof package refresh | 文月 栞里 / 白瀬 怜奈 | routing/evidence/approvalの波が進んだので、公開証跡の見え方を必要なら整える。 | README claimを変えずに、証跡リンクだけ確認できる。 |
