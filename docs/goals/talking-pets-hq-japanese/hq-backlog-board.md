...
| --- | --- | --- | --- |
| Local TTS設計 | 歌澄 音羽 | Active | VOICEVOX/Irodori外部検証継続、sherpa設計、MeloTTS設計の選択肢をMasterが選べるようにする。 |
...
| T166-T170 | HQ Activity Index、Minimal Multilingual Report Form、report form follow-up copy、HQ Backlog Board、Ready-To-Send Queue。 | [Activity Index](activity-index.md), [Real-device verification](../../real-device-verification.md#minimal-multilingual-report-form), [HQ Backlog Board](hq-backlog-board.md), [Outreach targets](../../research/x-outreach-targets.md#ready-to-send-queue) |
