...
| --- | --- | --- | --- |
| Outreach waiting lane boundary watch | 星宮 未来 / 白瀬 怜奈 | Active | 送信済みoutreachは再送・催促せず、返信が来た時だけsafe intakeへ回す。 |
...
| Multilingual verification boundary refresh | 言守 詞葉 / 白瀬 怜奈 | Korean / Chineseはfallback-only維持で、provider-specific evidenceが来た時だけchecklistへ回す。 | claim変更なしで、次回watchの入口が明確になる。 |
