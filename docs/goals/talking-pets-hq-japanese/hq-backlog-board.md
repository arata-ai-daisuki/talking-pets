...
| --- | --- | --- | --- |
| Outreach send queue refresh | 星宮 未来 | Active | README/SNS導線とprovider scorecardが現行化されたので、手動送信候補の優先順と記録場所を再点検する。 |
...
| Scorecard evidence follow-up | 歌澄 音羽 / 白瀬 怜奈 | Provider scorecardのgapが明確になったので、必要ならdesign note質問へ落とし込む。 | 実験承認が必要な項目とdocs-onlyで進められる項目が分かれている。 |
